        ...
        case 0x03://ELMO界面
        {
            switch(usart.RxBuffer_USART2[5])
            {
				...
				case 0x04:
				{
					...
					{
						case 0x02: 
							VESCmotor[VESC_id1].enable=usart.RxBuffer_USART2[8];
						break;
						case 0x03:
							VESCmotor[VESC_id2].enable=usart.RxBuffer_USART2[8];
						break;
						case 0x04:
							VESCmotor[VESC_id1].begin=usart.RxBuffer_USART2[8];
						break;
						case 0x05:
							VESCmotor[VESC_id2].begin=usart.RxBuffer_USART2[8];
						break;
						case 0x06:
